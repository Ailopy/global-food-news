...
S_TOPIC_SITES = [
    {
        ...
        "rss_candidates": [
            # Google News RSS：精准锁定食品饮料，排除汽车等无关行业
            # 搜索词策略：site:nikkei.com + 食品饮料关键词 -自动車 -車両
            "https://news.google.com/rss/search?q=site:nikkei.com+%E9%A3%9F%E5%93%81+%E6%96%B0%E5%95%86%E5%93%81+-%E8%87%AA%E5%8B%95%E8%BB%8A+-%E8%BB%8A%E4%B8%A1&hl=ja&gl=JP&ceid=JP:ja",
            "https://news.google.com/rss/search?q=site:nikkei.com+%E9%A3%9F%E5%93%81+%E9%A3%B2%E6%96%99+-%E8%87%AA%E5%8B%95%E8%BB%8A&hl=ja&gl=JP&ceid=JP:ja",
...
FOOD_BEV_EXCLUDE_KEYWORDS = [
    ...
    "自動運転", "運転支援", "クルマ", "車両",
    # ── 汽车车型名（日文常见车型）──
    "ロードスター", "スポーツカー", "オープンカー", "キャブリオレ",
    "軽自動車", "ミニバン", "セダン", "ハッチバック", "クーペ",
    "コンバーチブル", "ワゴン車", "ピックアップトラック", "rv",
    "インプレッサ", "シビック", "カローラ", "アクア", "プリウス",
    "アテンザ", "cx-5", "cx-8", "cx-30", "デミオ",
    "フリード", "アルファード", "クラウン", "レヴォーグ",
    "ヴォクシー", "ノア", "エスクード", "ランドクルーザー",
    "ハリアー", "レクサス", "gt-r", "フェアレディ",
    "ライズ", "ロック", "ヤリス", "カローラクロス",
    "スバルxv", "フォレスター", "outback", "レガシィ",
    "ヴェゼル", "n-box", "ミラ", "コペン", "デイズ",
    "カスタム", "スペーシア", "ハスラー", "ジムニー",
    "オデッセイ", "ステップワゴン", "e-clas", "c-hr",
    # ── 汽车描述高频词（日文）──
    "オープンスポーツカー", "特別仕様車", "新塗装色", "新車", "車両価格",
    "走行性能", "操縦安定性", "制動力", "サスペンション", "ホイール",
    "予約受け付け", "改良発売", "完売モデル", "マイナーチェンジ",
    "フルモデルチェンジ", "新タイプ", "タイプ追加",
    # ── 车型/术语（中文）──
